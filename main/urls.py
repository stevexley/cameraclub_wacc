...
urlpatterns = [
    ...
    path('competitions/<int:pk>/edit_prints/', PrintImageBulkEditView.as_view(), name='competition_edit_prints'),
#    path('competitions/<int:pk>/judge/', JudgeJudgingView.as_view(), name='competition_judge'),
    ...
    path('competitions/print_voting', PrintVotingView.as_view(), name='print_voting'),
    path('competitions/print_paper_voting', PrintPaperVotingView.as_view(), name='print_paper_voting'),
    path('competitions/<int:competition_id>/printvotetally/', print_vote_tally_view, name='printvotetally'),
